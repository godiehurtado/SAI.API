...
namespace ColpatriaSAI.Servicios.Web
{
    public class InvocarMetodoWS
    {
        ...
        public InvocarMetodoWS(string RutaWsdl)
        {
            factory = new DynamicProxyFactory(RutaWsdl);
        }

        public string Invocarmetodo( string wsdlportType, string metodo, params object[] parameters)
        {
